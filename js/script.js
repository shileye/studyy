const DB_KEY = "algo_v7_cow";
    ...
    function copyReport() {
        ...
        navigator.clipboard.writeText(text).then(() => alert("📊 PRO 战报已复制！"));
    }
    ...
    function renderUI() {
        ...
        showTodos.forEach(t => {
            ...
            <div class="todo-item ${t.done?'done':''}">
                ...
                ${!t.done?`<button class="btn btn-ai" style="padding:4px 8px;font-size:0.75rem" onclick="setPendingTodo('${t.text}')">提交</button>`:'<span>✔️</span>'}
            </div>`;
        });
